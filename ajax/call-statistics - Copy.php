...
switch($reporton)
{
	case 'statistics':
	{
			$f0 = runmysqlqueryfetch("SELECT COUNT(*) AS totalcallcount FROM ssm_callregister LEFT JOIN ssm_users ON ssm_users.slno = ssm_callregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno WHERE date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f1 = runmysqlqueryfetch("SELECT COUNT(*) AS totalemailcount FROM ssm_emailregister LEFT JOIN ssm_users ON ssm_users.slno = ssm_emailregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno WHERE date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f2 = runmysqlqueryfetch("SELECT COUNT(*) AS totalerrorcount FROM ssm_errorregister LEFT JOIN ssm_users ON ssm_users.slno = ssm_errorregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno WHERE date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$supportunitpiece.$anonymouspiece);
		
		$f3 = runmysqlqueryfetch("SELECT COUNT(*) AS totalinhousecount FROM ssm_inhouseregister LEFT JOIN ssm_users ON ssm_users.slno = ssm_inhouseregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno WHERE date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f4 = runmysqlqueryfetch("SELECT COUNT(*) AS totalonsitecount FROM ssm_onsiteregister LEFT JOIN ssm_users ON ssm_users.slno = ssm_onsiteregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno WHERE date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f5 = runmysqlqueryfetch("SELECT COUNT(*) AS totalreferencecount FROM ssm_referenceregister LEFT JOIN ssm_users ON ssm_users.slno = ssm_referenceregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno WHERE date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece1.$supportunitpiece.$anonymouspiece);
		
		$f6 = runmysqlqueryfetch("SELECT COUNT(*) AS totalrequirementcount FROM ssm_requirementregister LEFT JOIN ssm_users ON ssm_users.slno = ssm_requirementregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno WHERE date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$supportunitpiece.$anonymouspiece);
		...
		$f8 = runmysqlqueryfetch("SELECT COUNT(*) AS totalcallcount1 FROM ssm_callregister   LEFT JOIN ssm_users ON ssm_users.slno = ssm_callregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f10 = runmysqlqueryfetch("SELECT COUNT(*) AS totalerrorcount1 FROM ssm_errorregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_errorregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f11 = runmysqlqueryfetch("SELECT COUNT(*) AS totalinhousecount1 FROM ssm_inhouseregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_inhouseregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		WHERE status = 'solved' AND date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f12 = runmysqlqueryfetch("SELECT COUNT(*) AS totalonsitecount1 FROM ssm_onsiteregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_onsiteregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		WHERE status = 'solved' AND date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f13 = runmysqlqueryfetch("SELECT COUNT(*) AS totalreferencecount1 FROM ssm_referenceregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_referenceregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno
		...
		$f14 = runmysqlqueryfetch("SELECT COUNT(*) AS totalrequirementcount1 FROM ssm_requirementregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_requirementregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		WHERE status = 'solved' AND date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$supportunitpiece.$anonymouspiece);
		...
		$f16 = runmysqlqueryfetch("SELECT COUNT(*) AS totalcallcount2 FROM ssm_callregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_callregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f17 = runmysqlqueryfetch("SELECT COUNT(*) AS totalemailcount2 FROM ssm_emailregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_emailregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		WHERE status = 'unsolved' AND date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f18 = runmysqlqueryfetch("SELECT COUNT(*) AS totalerrorcount2 FROM ssm_errorregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_errorregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f19 = runmysqlqueryfetch("SELECT COUNT(*) AS totalinhousecount2 FROM ssm_inhouseregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_inhouseregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		WHERE status = 'unsolved' AND date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f20 = runmysqlqueryfetch("SELECT COUNT(*) AS totalonsitecount2 FROM ssm_onsiteregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_onsiteregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		WHERE status = 'unsolved' AND date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f21 = runmysqlqueryfetch("SELECT COUNT(*) AS totalreferencecount2 FROM ssm_referenceregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_referenceregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno
		...
		$f22 = runmysqlqueryfetch("SELECT COUNT(*) AS totalrequirementcount2 FROM ssm_requirementregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_requirementregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		WHERE status = 'unsolved' AND date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$supportunitpiece.$anonymouspiece);
		...
		$f24 = runmysqlqueryfetch("SELECT COUNT(*) AS totalcallcount3 FROM ssm_callregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_callregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f25 = runmysqlqueryfetch("SELECT COUNT(*) AS totalemailcount3 FROM ssm_emailregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_emailregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f26 = runmysqlqueryfetch("SELECT COUNT(*) AS totalinhousecount3 FROM ssm_inhouseregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_inhouseregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f27 = runmysqlqueryfetch("SELECT COUNT(*) AS totalonsitecount3 FROM ssm_onsiteregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_onsiteregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		WHERE status = 'notyetattended' AND date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f28 = runmysqlqueryfetch("SELECT COUNT(*) AS totalreferencecount3 FROM ssm_referenceregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_referenceregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno
		...
		$f30 = runmysqlqueryfetch("SELECT COUNT(*) AS totalcallcount4 FROM ssm_callregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_callregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f31 = runmysqlqueryfetch("SELECT COUNT(*) AS totalemailcount4 FROM ssm_emailregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_emailregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f32 = runmysqlqueryfetch("SELECT COUNT(*) AS totalinhousecount4 FROM ssm_inhouseregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_inhouseregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f33 = runmysqlqueryfetch("SELECT COUNT(*) AS totalonsitecount4 FROM ssm_onsiteregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_onsiteregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		WHERE status = 'inprocess' AND date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f34 = runmysqlqueryfetch("SELECT COUNT(*) AS totalreferencecount4 FROM ssm_referenceregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_referenceregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno
		...
		$f35 = runmysqlqueryfetch("SELECT COUNT(*) AS totalinhousecount5 FROM ssm_inhouseregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_inhouseregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		...
		$f36 = runmysqlqueryfetch("SELECT COUNT(*) AS totalonsitecount5 FROM ssm_onsiteregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_onsiteregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno 
		WHERE status = 'skipped' AND date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$categorypiece.$callertype.$supportunitpiece.$anonymouspiece);
		
		$f37 = runmysqlqueryfetch("SELECT COUNT(*) AS totalreferencecount5 FROM ssm_referenceregister  LEFT JOIN ssm_users ON ssm_users.slno = ssm_referenceregister.userid LEFT JOIN ssm_supportunits ON ssm_users.supportunit = ssm_supportunits.slno
...
';
	...
	case 'details':
	{
		for($k = 0; $k < count($registers)-1; $k++)
		{
			if($registers[$k] == 'Call')
			{
				$grid .='<table width="100%" border="0" cellspacing="0" cellpadding="3"><tr><td>&nbsp;</td><td  style="padding-left:15px;"><h2>Call Register</h2></td></tr></table>';
				
				$grid .='<table width="100%" cellpadding="3" cellspacing="0" class="table-border-grid"><tr><td nowrap = "nowrap" class="td-border-grid">Sl No</td><td nowrap = "nowrap" class="td-border-grid">Flag</td><td nowrap = "nowrap" class="td-border-grid">Anonymous</td><td nowrap = "nowrap" class="td-border-grid">Customer Name</td><td nowrap = "nowrap" class="td-border-grid">Customer ID</td><td nowrap = "nowrap" class="td-border-grid">Date</td><td nowrap = "nowrap" class="td-border-grid">Time</td><td nowrap = "nowrap" class="td-border-grid">Person Name</td><td nowrap = "nowrap" class="td-border-grid">Category</td><td nowrap = "nowrap" class="td-border-grid">Caller Type</td><td nowrap = "nowrap" class="td-border-grid">Product Name</td><td nowrap = "nowrap" class="td-border-grid">Product Version</td><td nowrap = "nowrap" class="td-border-grid">Problem</td><td nowrap = "nowrap" class="td-border-grid">Status</td><td nowrap = "nowrap" class="td-border-grid">Remote Connection</td><td nowrap = "nowrap" class="td-border-grid">Remarks</td><td nowrap = "nowrap" class="td-border-grid">User Id</td><td nowrap = "nowrap" class="td-border-grid">Compliant ID</td><td nowrap = "nowrap" class="td-border-grid">Authorized</td><td nowrap = "nowrap" class="td-border-grid">Authorized Group</td><td nowrap = "nowrap" class="td-border-grid">Team Leader Remarks</td><td nowrap = "nowrap" class="td-border-grid">Authorized Person</td><td nowrap = "nowrap" class="td-border-grid">Authorized Date&amp;Time</td><td nowrap = "nowrap" class="td-border-grid">End Time</td></tr>
	';
			...
			if($registers[$k] == 'Error')
			{
				$grid .='<table width="100%" border="0" cellspacing="0" cellpadding="3"><tr><td  nowrap = "nowrap" class="td-border-grid">&nbsp;</td><td  style="padding-left:15px;"><h2>Error Register</h2></td></tr></table>';
	...
	LEFT JOIN ssm_category on ssm_category.slno =ssm_errorregister.authorizedgroup  WHERE date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$supportunitpiece.$anonymouspiece." ORDER BY  `date` DESC ";
			...
			if($registers[$k] == 'Inhouse')
			{
						$grid .='<table width="100%" border="0" cellspacing="0" cellpadding="3"><tr><td  nowrap = "nowrap" class="td-border-grid">&nbsp;</td><td  style="padding-left:15px;"><h2>Inhouse Register</h2></td></tr></table>';
	...
	LEFT JOIN ssm_category on ssm_category.slno =ssm_inhouseregister.authorizedgroup WHERE date BETWEEN '".changedateformat($fromdate)."' AND '".changedateformat($todate)."'".$userpiece.$supportunitpiece.$anonymouspiece.$categorypiece.$callertype." ORDER BY  `date` DESC ";
			...
			if($registers[$k] == 'Onsite')
			{
				$grid .='<table width="100%" border="0" cellspacing="0" cellpadding="3"><tr><td  nowrap = "nowrap" class="td-border-grid">&nbsp;</td><td  style="padding-left:15px;"><h2>Onsite Register</h2></td></tr></table>';
					
				$grid .='<table width="100%" cellpadding="3" cellspacing="0" class="table-border-grid"><tr><td nowrap = "nowrap" class="td-border-grid">Sl No</td><td nowrap = "nowrap" class="td-border-grid">Flag</td><td nowrap = "nowrap" class="td-border-grid">Anonymous</td><td nowrap = "nowrap" class="td-border-grid">Customer Name</td><td nowrap = "nowrap" class="td-border-grid">Customer ID</td><td nowrap = "nowrap" class="td-border-grid">Date</td><td nowrap = "nowrap" class="td-border-grid">Time</td><td nowrap = "nowrap" class="td-border-grid">Product Name</td><td nowrap = "nowrap" class="td-border-grid">Product Version</td><td nowrap = "nowrap" class="td-border-grid">Category</td><td nowrap = "nowrap" class="td-border-grid">Caller Type</td><td nowrap = "nowrap" class="td-border-grid">Service Charge</td><td nowrap = "nowrap" class="td-border-grid">Problem</td><td nowrap = "nowrap" class="td-border-grid">Contact Person</td><td nowrap = "nowrap" class="td-border-grid">Assigned To</td><td nowrap = "nowrap" class="td-border-grid">Status</td><td nowrap = "nowrap" class="td-border-grid">Solved By</td><td  nowrap = "nowrap" class="td-border-grid">S. T. Remote Connection</td>
			...
			<td  nowrap = "nowrap" class="td-border-grid">S. T. Mail</td><td nowrap = "nowrap" class="td-border-grid">Solved Date</td><td nowrap = "nowrap" class="td-border-grid">Bill Number</td><td nowrap = "nowrap" class="td-border-grid">Bill Date</td><td nowrap = "nowrap" class="td-border-grid">Acknowledgement Number</td><td nowrap = "nowrap" class="td-border-grid">Remarks</td><td nowrap = "nowrap" class="td-border-grid">User ID</td><td nowrap = "nowrap" class="td-border-grid">Complaint ID</td><td nowrap = "nowrap" class="td-border-grid">Authorized</td><td nowrap = "nowrap" class="td-border-grid">Authorized Group</td><td nowrap = "nowrap" class="td-border-grid">Team Leader Remarks</td><td nowrap = "nowrap" class="td-border-grid">Authorized Person</td><td nowrap = "nowrap" class="td-border-grid">Authorized Date&Time</td></tr>';
...
$grid .= '<td nowrap = "nowrap" class="td-border-grid"><font color="#333333" style="font-size:11px; font-family:Calibri;">'.$j.'</td>';
			...
			{
				if($i == 5 || $i == 22 || $i == 24)
				$grid .= '<td nowrap = "nowrap" class="td-border-grid"><font color="#333333" style="font-size:11px; font-family:Calibri;">'.changedateformat($fetch[$i]).'</td>';
				else
		...
		$grid .= '</table>';
			...
			if($registers[$k] == 'Requirement')
			{
						$grid .='<table width="100%" border="0" cellspacing="0" cellpadding="3"><tr><td  nowrap = "nowrap" class="td-border-grid">&nbsp;</td><td  style="padding-left:15px;"><h2>Requirement Register</h2></td></tr></table>';
			...
			if($registers[$k] == 'Skype')
			{
						$grid .='<table width="100%" border="0" cellspacing="0" cellpadding="3"><tr><td  nowrap = "nowrap" class="td-border-grid">&nbsp;</td><td  style="padding-left:15px;"><h2>Skype Register</h2></td></tr></table>';
...
';
		...
		for($k = 0; $k < count($registers)-1; $k++)
		{
				if($registers[$k] == 'Call')
				{
					$grid .='<table width="100%" border="0" cellspacing="0" cellpadding="3"><tr><td  nowrap = "nowrap" class="td-border-grid">&nbsp;</td><td  style="padding-left:15px;"><h2>Call Register</h2></td></tr></table>';
		...
		';
				...
				if($registers[$k] == 'Email')
				{
					...
					$grid .='<table width="100%" cellpadding="3" cellspacing="0" border="1"><tr><td  nowrap = "nowrap" class="td-border-grid">Sl No</td><td  nowrap = "nowrap" class="td-border-grid">Flag</td><td nowrap = "nowrap" class="td-border-grid">Anonymous</td><td  nowrap = "nowrap" class="td-border-grid">Anonymous</td><td  nowrap = "nowrap" class="td-border-grid">Customer Name</td><td  nowrap = "nowrap" class="td-border-grid">Customer ID</td><td  nowrap = "nowrap" class="td-border-grid">Product Name</td><td  nowrap = "nowrap" class="td-border-grid">Product Version</td><td  nowrap = "nowrap" class="td-border-grid">Date</td><td  nowrap = "nowrap" class="td-border-grid">Time</td><td  nowrap = "nowrap" class="td-border-grid">Caller Type</td><td  nowrap = "nowrap" class="td-border-grid">Category</td><td  nowrap = "nowrap" class="td-border-grid">Person Name</td><td  nowrap = "nowrap" class="td-border-grid">Email ID</td><td  nowrap = "nowrap" class="td-border-grid">Subject</td><td  nowrap = "nowrap" class="td-border-grid">Content</td><td  nowrap = "nowrap" class="td-border-grid">Error File</td><td  nowrap = "nowrap" class="td-border-grid">Status</td><td  nowrap = "nowrap" class="td-border-grid">Thanking Email</td><td  nowrap = "nowrap" class="td-border-grid">Remarks</td><td  nowrap = "nowrap" class="td-border-grid">User ID</td><td  nowrap = "nowrap" class="td-border-grid">Compliant ID</td><td  nowrap = "nowrap" class="td-border-grid">Authorized</td><td  nowrap = "nowrap" class="td-border-grid">Authorized Group</td><td  nowrap = "nowrap" class="td-border-grid">Team Leader Remarks</td><td  nowrap = "nowrap" class="td-border-grid">Authorized Person</td><td  nowrap = "nowrap" class="td-border-grid">Authorized Date&Time</td></tr>';
