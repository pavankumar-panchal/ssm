			...
			if (strlen($searchcriteria) > 0) {
				switch ($orderby) {
					...
					case 'reportingauthority':
						$orderbyfield = 'reportingauthority';
						break;
					case 'supportunit':
						$orderbyfield = 'supportunit';
						break;
					case 'existinguser':
						$orderbyfield = 'existinguser';
						break;
					case 'gender':
						$orderbyfield = 'gender';
						break;
				...
				switch ($selection) {
					case 'username':
						$textfield = "username LIKE '%" . $searchcriteria . "%'";
						break;
					case 'type':
						$textfield = "type LIKE '%" . $searchcriteria . "%'";
						break;
					case 'locationname':
						$textfield = "locationname LIKE '%" . $searchcriteria . "%'";
						break;
					case 'reportingauthority':
						$textfield = "reportingauthority LIKE '%" . $searchcriteria . "%'";
						break;
					case 'supportunit':
						$textfield = "supportunit LIKE '%" . $searchcriteria . "%'";
						break;
					case 'existinguser':
						$textfield = "existinguser LIKE '%" . $searchcriteria . "%'";
						break;
					case 'gender':
						$textfield = "gender LIKE '%" . $searchcriteria . "%'";
						break;
				}
