...
<head>
	...
	<style>
		#text {
			...
			/* Old browsers */
			background: -moz-linear-gradient(top, rgba(240, 249, 255, 1) 99%, rgba(161, 219, 255, 1) 99%);
			/* FF3.6+ */
			background: -webkit-gradient(linear, left top, left bottom, color-stop(99%, rgba(240, 249, 255, 1)), color-stop(99%, rgba(161, 219, 255, 1)));
			/* Chrome,Safari4+ */
			background: -webkit-linear-gradient(top, rgba(240, 249, 255, 1) 99%, rgba(161, 219, 255, 1) 99%);
			/* Chrome10+,Safari5.1+ */
			background: -o-linear-gradient(top, rgba(240, 249, 255, 1) 99%, rgba(161, 219, 255, 1) 99%);
			/* Opera 11.10+ */
			background: -ms-linear-gradient(top, rgba(240, 249, 255, 1) 99%, rgba(161, 219, 255, 1) 99%);
			/* IE10+ */
			background: linear-gradient(to bottom, rgba(240, 249, 255, 1) 99%, rgba(161, 219, 255, 1) 99%);
			/* W3C */
