			...
			if (strlen($searchcriteria) > 0) {
				switch ($orderby) {
					...
					case 'place':
						...
						break;
					case 'district':
						$orderbyfield = 'district';
						break;
					case 'state':
						$orderbyfield = 'state';
						break;
					case 'skypeid':
						$orderbyfield = 'skypeid';
						break;
				}
				switch ($selection) {
					case 'slno':
						$textfield = "slno LIKE '%" . $searchcriteria . "%'";
						break;
					case 'dealercompanyname':
						$textfield = "dealercompanyname LIKE '%" . $searchcriteria . "%'";
						break;
					case 'dealername':
						$textfield = "dealername LIKE '%" . $searchcriteria . "%'";
						break;
					case 'contactnumber':
						$textfield = "contactnumber LIKE '%" . $searchcriteria . "%'";
						break;
					case 'emailid':
						$textfield = "emailid LIKE '%" . $searchcriteria . "%'";
						break;
					case 'category':
						$textfield = "category LIKE '%" . $searchcriteria . "%'";
						break;
					case 'place':
						$textfield = "place LIKE '%" . $searchcriteria . "%'";
						break;
					case 'district':
						$textfield = "district LIKE '%" . $searchcriteria . "%'";
						break;
					case 'state':
						$textfield = "state LIKE '%" . $searchcriteria . "%'";
						break;
					case 'skypeid':
						$textfield = "skypeid LIKE '%" . $searchcriteria . "%'";
						break;
				}
