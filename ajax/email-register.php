...
<a onclick ="getmore(\'' . $startlimit . '\',\'' . $slno1 . '\',\'more\');" style="cursor:pointer" class="resendtext">Show More Records >> </a><a onclick ="getmore(\'' . $startlimit . '\',\'' . $slno1 . '\',\'all\');" class="resendtext1" style="cursor:pointer"><font color = "#000000">(Show All Records)</font></a></a>&nbsp;&nbsp;&nbsp;</div></td>
	...
	case 'searchfilter': {
			...
			switch ($orderby) {
				case 'callertype':
					$orderbyfield = 'ssm_emailregister.callertype';
					break;
				case 'category':
					$orderbyfield = 'ssm_emailregister.category';
					break;
				case 'state':
					$orderbyfield = 'ssm_emailregister.state';
					break;
				case 'compliantid':
					$orderbyfield = 'ssm_emailregister.compliantid';
					break;
				case 'content':
					$orderbyfield = 'ssm_emailregister.content';
					break;
				case 'customerid':
					$orderbyfield = 'ssm_emailregister.customerid';
					break;
				case 'customername':
					$orderbyfield = 'ssm_emailregister.customername';
					break;
				case 'date':
					$orderbyfield = 'ssm_emailregister.date';
					break;
				case 'forwardedto':
					$orderbyfield = 'ssm_emailregister.forwardedto';
					break;
				case 'userid':
					$orderbyfield = 'ssm_emailregister.userid';
					break;
				case 'productgroup':
					$orderbyfield = 'ssm_emailregister.productgroup';
					break;
				case 'productname':
					$orderbyfield = 'ssm_emailregister.productname';
					break;
				case 'status':
					$orderbyfield = 'ssm_emailregister.status';
					break;
				case 'time':
					$orderbyfield = 'ssm_emailregister.time';
					break;
			}
