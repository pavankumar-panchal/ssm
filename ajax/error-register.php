...
<font color = "#000000">(Show All Records)</font></a></a>&nbsp;&nbsp;&nbsp;</div>&nbsp;&nbsp;&nbsp;</div></td>
	...
	case 'searchfilter': {
			...
			switch ($orderby) {
				case 'customername':
					$orderbyfield = 'ssm_errorregister.customername';
					break;
				case 'state':
					$orderbyfield = 'ssm_errorregister.state';
					break;
				case 'productgroup':
					$orderbyfield = 'ssm_errorregister.productgroup';
					break;
				case 'productname':
					$orderbyfield = 'ssm_errorregister.productname';
					break;
				case 'errorreported':
					$orderbyfield = 'ssm_errorregister.errorreported';
					break;
				case 'reportedto':
					$orderbyfield = 'ssm_errorregister.reportedto';
					break;
				case 'errorfile':
					$orderbyfield = 'ssm_errorregister.errorfile';
					break;
				case 'status':
					$orderbyfield = 'ssm_errorregister.status';
					break;
				case 'solveddate':
					$orderbyfield = 'ssm_errorregister.solveddate';
					break;
				case 'solutiongiven':
					$orderbyfield = 'ssm_errorregister.solutiongiven';
					break;
				case 'solutionfile':
					$orderbyfield = 'ssm_errorregister.solutionfile';
					break;
				case 'remarks':
					$orderbyfield = 'ssm_errorregister.remarks';
					break;
				case 'userid':
					$orderbyfield = 'ssm_errorregister.userid';
					break;
				case 'errorid':
					$orderbyfield = 'ssm_errorregister.errorid';
					break;
				case 'time':
					$orderbyfield = 'ssm_errorregister.time';
					break;
			}
