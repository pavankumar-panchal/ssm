...
style="cursor:pointer"><font color = "#000000">(Show All Records)</font></a></a>&nbsp;&nbsp;&nbsp;</div>&nbsp;&nbsp;&nbsp;</div>
	...
	case 'searchfilter': {
			...
			$categorykkg = $_POST['categorykkg'];
			$categorycsd = $_POST['categorycsd'];
			$categoryblr = $_POST['categoryblr'];
			if (($categorykkg == "true") && ($categoryblr == "true") && ($categorycsd == "true")) {
				$s_categorypiece = "";
			...
			elseif (($employee == "true") && ($customer == "true") && ($dealer == "true")) {
				...
				$s_callertypepiece = "AND callertype='dealer'";
			} elseif (($employee == "true")) {
				$s_callertypepiece = "AND callertype='employee'";
			} elseif (($ssmuser == "true")) {
				$s_callertypepiece = "AND callertype='ssmuser'";
			}
			...
			switch ($orderby) {
				case 'customername':
					$orderbyfield = 'ssm_inhouseregister.customername';
					break;
				case 'customerid':
					$orderbyfield = 'ssm_inhouseregister.customerid';
					break;
				case 'category':
					$orderbyfield = 'ssm_inhouseregister.category';
					break;
				case 'state':
					$orderbyfield = 'ssm_inhouseregister.state';
					break;
				case 'callertype':
					$orderbyfield = 'ssm_inhouseregister.callertype';
					break;
				case 'productgroup':
					$orderbyfield = 'ssm_inhouseregister.productgroup';
					break;
				case 'productname':
					$orderbyfield = 'ssm_inhouseregister.productname';
					break;
				case 'status':
					$orderbyfield = 'ssm_inhouseregister.status';
					break;
				case 'problem':
					$orderbyfield = 'ssm_inhouseregister.problem';
					break;
				case 'solvedby':
					$orderbyfield = 'ssm_inhouseregister.solvedby';
					break;
				case 'billno':
					$orderbyfield = 'ssm_inhouseregister.billno';
					break;
				case 'acknowledgementno':
					$orderbyfield = 'ssm_inhouseregister.acknowledgementno';
					break;
				case 'complaintid':
					$orderbyfield = 'ssm_inhouseregister.complaintid';
					break;
				case 'userid':
					$orderbyfield = 'ssm_inhouseregister.userid';
					break;
			}
