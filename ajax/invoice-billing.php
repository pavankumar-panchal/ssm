	...
	case 'searchfilter': {
			...
			switch ($orderby) {
				...
				case 'customerid':
					...
					break;
				case 'productgroup':
					$orderbyfield = 'ssm_invoice.productgroup';
					break;
				case 'productname':
					$orderbyfield = 'ssm_invoice.productname';
					break;
				case 'state':
					$orderbyfield = 'ssm_invoice.state';
					break;
				case 'billno':
					$orderbyfield = 'ssm_invoice.billno';
					break;
				case 'billdate':
					$orderbyfield = 'ssm_invoice.billdate';
					break;
				case 'registername':
					$orderbyfield = 'ssm_invoice.registername';
					break;
				case 'billedby':
					$orderbyfield = 'ssm_invoice.billedby';
					break;
				case 'amount':
					$orderbyfield = 'ssm_invoice.amount';
					break;
				case 'userid':
					$orderbyfield = 'ssm_invoice.userid';
					break;
				case 'complaintid':
					$orderbyfield = 'ssm_invoice.complaintid';
					break;
			}
