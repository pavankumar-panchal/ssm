...
style="cursor:pointer"><font color = "#000000">(Show All Records)</font></a></a>&nbsp;&nbsp;&nbsp;</div></td>
	...
	case 'searchfilter': {
			...
			elseif (($employee == "true") && ($customer == "true") && ($dealer == "true")) {
				...
				$s_callertypepiece = "AND callertype='outstationemployee'";
			} elseif (($ssmuser == "true")) {
			...
			switch ($orderby) {
				...
				case 'customerid':
					...
					break;
				case 'category':
					$orderbyfield = 'ssm_onsiteregister.category';
					break;
				case 'state':
					$orderbyfield = 'ssm_onsiteregister.state';
					break;
				case 'callertype':
					$orderbyfield = 'ssm_onsiteregister.callertype';
					break;
				case 'productgroup ':
					$orderbyfield = 'ssm_onsiteregister.productgroup';
					break;
				case 'productname ':
					$orderbyfield = 'ssm_onsiteregister.productname';
					break;
				case 'status':
					$orderbyfield = 'ssm_onsiteregister.status';
					break;
				case 'problem':
					$orderbyfield = 'ssm_onsiteregister.problem';
					break;
				case 'solvedby':
					$orderbyfield = 'ssm_onsiteregister.solvedby';
					break;
				case 'solveddate':
					$orderbyfield = 'ssm_onsiteregister.solveddate';
					break;
				case 'billno':
					$orderbyfield = 'ssm_onsiteregister.billno';
					break;
				case 'billdate':
					$orderbyfield = 'ssm_onsiteregister.billdate';
					break;
				case 'acknowledgementno ':
					$orderbyfield = 'ssm_onsiteregister.acknowledgementno';
					break;
				case 'complaintid':
					$orderbyfield = 'ssm_onsiteregister.complaintid';
					break;
				case 'userid':
					$orderbyfield = 'ssm_onsiteregister.userid';
					break;
			}
