			...
			if (strlen($searchcriteria) > 0) {
				switch ($orderby) {
					...
					case 'productname':
						...
						break;
					case 'shortformat':
						$orderbyfield = 'shortformat';
						break;
					case 'productgroup':
						$orderbyfield = 'productgroup';
						break;
					case 'productinuse':
						$orderbyfield = 'productinuse';
						break;
				...
				switch ($selection) {
					case 'slno':
						...
						break;
					case 'productname':
						$textfield = "productname LIKE '%" . $searchcriteria . "%'";
						break;
					case 'shortformat':
						$textfield = "shortformat LIKE '%" . $searchcriteria . "%'";
						break;
					case 'productgroup':
						$textfield = "productgroup LIKE '%" . $searchcriteria . "%'";
						break;
					case 'productinuse':
						$textfield = "productinuse LIKE '%" . $searchcriteria . "%'";
						break;
				}
