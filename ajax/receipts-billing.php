...
switch ($type) {
	...
	case 'searchfilter': {
			...
			switch ($orderby) {
				case 'customername':
					$orderbyfield = 'ssm_receipts.customername';
					break;
				case 'customerid':
					$orderbyfield = 'ssm_receipts.customerid';
					break;
				case 'billno':
					$orderbyfield = 'ssm_receipts.billno';
					break;
				case 'billdate':
					$orderbyfield = 'ssm_receipts.billdate';
					break;
				case 'receiptno':
					$orderbyfield = 'ssm_receipts.receiptno';
					break;
				case 'receiptdate':
					$orderbyfield = 'ssm_receipts.receiptdate';
					break;
				case 'chequeno':
					$orderbyfield = 'ssm_receipts.chequeno';
					break;
				case 'userid':
					$orderbyfield = 'ssm_receipts.userid';
					break;
			}
