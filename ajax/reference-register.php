...
WHERE ssm_category.slno = '" . $result['authorizedgroup'] . "'");
	...
	case 'searchfilter': {
			...
			switch ($orderby) {
				case 'contactperson':
					$orderbyfield = 'ssm_referenceregister.contactperson';
					break;
				case 'customername':
					$orderbyfield = 'ssm_referenceregister.customername';
					break;
				case 'category':
					$orderbyfield = 'ssm_referenceregister.category';
					break;
				case 'state':
					$orderbyfield = 'ssm_referenceregister.state';
					break;
				case 'productgroup':
					$orderbyfield = 'ssm_referenceregister.productgroup';
					break;
				case 'productname':
					$orderbyfield = 'ssm_referenceregister.productname';
					break;
				case 'referencethrough':
					$orderbyfield = 'ssm_referenceregister.referencethrough';
					break;
				case 'contactno':
					$orderbyfield = 'ssm_referenceregister.contactno';
					break;
				case 'contactaddress':
					$orderbyfield = 'ssm_referenceregister.contactaddress';
					break;
				case 'status':
					$orderbyfield = 'ssm_referenceregister.status';
					break;
				case 'email':
					$orderbyfield = 'ssm_referenceregister.email';
					break;
				case 'userid':
					$orderbyfield = 'ssm_referenceregister.userid';
					break;
				case 'referenceid':
					$orderbyfield = 'ssm_referenceregister.referenceid';
					break;
				case 'time':
					$orderbyfield = 'ssm_referenceregister.time';
					break;
			}
