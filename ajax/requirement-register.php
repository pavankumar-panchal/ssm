...
style="cursor:pointer"><font color = "#000000">(Show All Records)</font></a></a>&nbsp;&nbsp;&nbsp;</div></td>
	...
	case 'searchfilter': {
			...
			switch ($orderby) {
				case 'customername':
					$orderbyfield = 'ssm_requirementregister.customername';
					break;
				case 'state':
					$orderbyfield = 'ssm_requirementregister.state';
					break;
				case 'productgroup':
					$orderbyfield = 'ssm_requirementregister.productgroup';
					break;
				case 'productname':
					$orderbyfield = 'ssm_requirementregister.productname';
					break;
				case 'requirement':
					$orderbyfield = 'ssm_requirementregister.requirement';
					break;
				case 'reportedto':
					$orderbyfield = 'ssm_requirementregister.reportedto';
					break;
				case 'status':
					$orderbyfield = 'ssm_requirementregister.status';
					break;
				case 'solveddate':
					$orderbyfield = 'ssm_requirementregister.solveddate';
					break;
				case 'solutiongiven':
					$orderbyfield = 'ssm_requirementregister.solutiongiven';
					break;
				case 'remarks':
					$orderbyfield = 'ssm_requirementregister.remarks';
					break;
				case 'userid':
					$orderbyfield = 'ssm_requirementregister.userid';
					break;
				case 'requirementid':
					$orderbyfield = 'ssm_requirementregister.requirementid';
					break;
				case 'time':
					$orderbyfield = 'ssm_requirementregister.time';
					break;
			}
