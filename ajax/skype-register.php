...
style="cursor:pointer"><font color = "#000000">(Show All Records)</font></a></a>&nbsp;&nbsp;&nbsp;</div></td>
	...
	case 'searchfilter': {
			...
			switch ($orderby) {
				case 'customername':
					$orderbyfield = 'ssm_skyperegister.customername';
					break;
				case 'customerid':
					$orderbyfield = 'ssm_skyperegister.customerid';
					break;
				case 'date':
					$orderbyfield = 'ssm_skyperegister.date';
					break;
				case 'category':
					$orderbyfield = 'ssm_skyperegister.category';
					break;
				case 'state':
					$orderbyfield = 'ssm_skyperegister.state';
					break;
				case 'callertype':
					$orderbyfield = 'ssm_skyperegister.callertype';
					break;
				case 'productgroup':
					$orderbyfield = 'ssm_skyperegister.productgroup';
					break;
				case 'productname':
					$orderbyfield = 'ssm_skyperegister.productname';
					break;
				case 'problem':
					$orderbyfield = 'ssm_skyperegister.problem';
					break;
				case 'status':
					$orderbyfield = 'ssm_skyperegister.status';
					break;
				case 'attachment':
					$orderbyfield = 'ssm_skyperegister.attachment';
					break;
				case 'userid':
					$orderbyfield = 'ssm_skyperegister.userid';
					break;
				case 'skypeid':
					$orderbyfield = 'ssm_skyperegister.skypeid';
					break;
				case 'time':
					$orderbyfield = 'ssm_skyperegister.time';
					break;
			}
