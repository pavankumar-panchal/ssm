                        ...
                        <td valign="top">
                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr bgcolor="#f7faff">
                              ...
                              <td valign="top" bgcolor="#EDF4FF"><input name="customername" type="text"
                                  class="swifttext" id="customername" size="30" />
                                <input type="hidden" name="lastslno2" id="lastslno2" value="" />
                                <input type="hidden" name="loggeduser2" id="loggeduser2"
                                  value="<?php echo ($user); ?>" />
                                <input type="hidden" name="loggedusertype2" id="loggedusertype2"
                                  value="<?php echo ($usertype); ?>" />
                                <input type="hidden" name="loggedreportingauthority2" id="loggedreportingauthority2"
