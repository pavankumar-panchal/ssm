...
function getpagelink($linkvalue)
{
	switch($linkvalue)
	{
		case 'home_dashboard': return '../home/index.php'; break;
		case 'home_setting': return '../home/settings.php'; break;
		case 'home_help': return '../home/help.php'; break;
		case 'master_users': return '../masters/users.php'; break;
		case 'master_customer': return '../masters/customer.php'; break;
		case 'master_dealers': return '../masters/dealers.php'; break;
		case 'master_locations': return '../masters/locations.php'; break;
		case 'master_osemployees': return '../masters/osemployee.php'; break;
		case 'master_product': return '../masters/products.php'; break;
		case 'master_version': return '../masters/versions.php'; break;
		case 'master_category': return '../masters/categories.php'; break;
		case 'master_supportunit': return '../masters/supportunits.php'; break;
		case 'master_nonworkingdays': return '../masters/non-workingdays.php'; break;
		case 'profile_changepassword': return '../profile/changepassword.php'; break;
		case 'profile_editprofile': return '../profile/editprofile.php'; break;
		case 'profile_completeprofile': return '../profile/completeprofile.php'; break;
		case 'profile_viewprofile': return '../profile/viewprofile.php'; break;
		case 'register_call': return '../registers/calls.php'; break;
		case 'register_email': return '../registers/emails.php'; break;
		case 'register_error': return '../registers/errors.php'; break;
		case 'register_requirement': return '../registers/requirement.php'; break;
		case 'register_reference': return '../registers/reference.php'; break;
		case 'register_skype': return '../registers/skype.php'; break;
		case 'register_onsite': return '../registers/onsite.php'; break;
		case 'register_inhouse': return '../registers/inhouse.php'; break;
		case 'billing_invoice': return '../billing/invoice.php'; break;
		case 'billing_receipts': return '../billing/receipts.php'; break;
		case 'logout': return '../logout.php'; break;
		case 'authorize_records': return '../masters/record-authorization.php'; break;
		case 'attendance_report': return '../attendance/attendance.php'; break;
		case 'attendance_report_adv': return '../attendance/attendance-adv.php'; break;
		case 'report_callstatistics': return '../reports/call-statistics.php'; break;
		case 'report_dailyreport': return '../reports/daily-report.php'; break;
		case 'report_bugstatistics': return '../reports/bug-statistics.php'; break;
		case 'report_requirementstatistics': return '../reports/requirement-statistics.php'; break;
		case 'report_onsitestatistics': return '../reports/onsite-statistics.php'; break;
		case 'report_onsitependings': return '../reports/onsite-pendingvisit.php'; break;
		case 'report_statisticschart': return '../reports/statisticschart.php'; break;
		case 'kb_add': return '../kb/add.php'; break;
		case 'kb_view': return '../kb/view.php'; break;
		default: return '../home/index.php'; break;
	}
}
...
function getpagetitle($linkvalue)
{
	switch($linkvalue)
	{
		case 'home_dashboard': return 'SSM : Dashboard'; break;
		case 'home_setting': return 'SSM : Settings'; break;
		case 'home_help': return 'SSM : Help'; break;
		case 'master_users': if($usertype <> 'ADMIN')  return 'SSM : Dashboard'; else return 'SSM : Users'; break;
		case 'master_customer': return 'SSM : Customer'; break;
		case 'master_dealers': return 'SSM : Dealers'; break;
		case 'master_locations': return 'SSM : Locations'; break;
		case 'master_osemployees': return 'SSM : Out Station Employees'; break;
		case 'master_product': return 'SSM : Products'; break;
		case 'master_version': return 'SSM : Product Versions'; break;
		case 'master_category': return 'SSM : Categories'; break;
		case 'master_supportunit': return 'SSM : Support Units'; break;
		case 'master_nonworkingdays': return 'SSM : Non Working Days'; break;
		case 'profile_changepassword': return 'SSM : Change Password'; break;
		case 'profile_editprofile': return 'SSM : Your Profile'; break;
		case 'profile_completeprofile': return 'SSM : Complete Your Profile'; break;
		case 'profile_viewprofile': return 'SSM : View Your Profile'; break;
		case 'register_call': return 'SSM : Call Register'; break;
		case 'register_email': return 'SSM : Email Register'; break;
		case 'register_error': return 'SSM : Error Register'; break;
		case 'register_requirement': return 'SSM : Requirement Register'; break;
		case 'register_reference': return 'SSM : Reference Register'; break;
		case 'register_skype': return 'SSM : Skype Register'; break;
		case 'register_onsite': return 'SSM : Onsite Register'; break;
		case 'register_inhouse': return 'SSM : Inhouse Register'; break;
		case 'billing_invoice': return 'SSM : Invoices'; break;
		case 'billing_receipts': return 'SSM : Receipts'; break;
		case 'logout': return 'SSM : Logout'; break;
		case 'authorize_records': return 'SSM : Authorize Records'; break;
		case 'attendance_report': return 'SSM : Attendance Report'; break;
		case 'attendance_report_adv': return 'SSM : Attendance Report - Advanced'; break;
		case 'report_callstatistics': return 'SSM : Call Statistics Report'; break;
		case 'report_dailyreport': return 'SSM : Daily Report'; break;
		case 'report_bugstatistics': return 'SSM : Bug Statistics Report'; break;
		case 'report_requirementstatistics': return 'SSM : Requirement Statistics Report'; break;
		case 'report_onsitestatistics': return 'SSM : Onsite Statistics Report'; break;
		case 'report_onsitependings': return 'SSM : Onsite Pendings Report'; break;
		case 'report_statisticschart': return 'SSM : Statistics Chart Report'; break;
		case 'kb_add': return 'SSM : Add Knowledge Base'; break;
		case 'kb_View': return 'SSM : View Knowledge Base'; break;
		default: return 'SSM : Dashboard'; break;
	}
}
...
function convertmonthtostring($month)
{
	switch($month)
	{
		case '01': $datestring = 'January'; break;
		case '02': $datestring = 'February'; break;
		case '03': $datestring = 'March'; break;
		case '04': $datestring = 'April'; break;
		case '05': $datestring = 'May'; break;
		case '06': $datestring = 'June'; break;
		case '07': $datestring = 'July'; break;
		case '08': $datestring = 'August'; break;
		case '09': $datestring = 'September'; break;
		case '10': $datestring = 'October'; break;
		case '11': $datestring = 'November'; break;
		case '12': $datestring = 'December'; break;
	}
	return $datestring;
}
...
href='JavaScript:calldatalist(\"".$customername."\",".$slno.");' >".$customername."</a></td>";
			...
			if(!isset($calls_count)){ $calls_count = null ;}
			if(!isset($chats_count)){ $chats_count = null ;}
			if(!isset($mails_count)){ $mails_count = null ;}
