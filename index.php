		...
		else
		{
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				else
				{
					...
					$url = './home/index.php?a_link=home_dashboard'; header("location:".$url);
...
<body bgcolor="#FFFFFF" onload="document.submitform.username.focus(); SetCookie('logincookiejs','logincookiejs'); if(!GetCookie('logincookiejs')) document.getElementById('form-error').innerHTML = '<span class=\'error-message\'>Enable cookies for this site </span>';">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="middle"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><form id="submitform" name="submitform" method="post" action="">
          <table width="25%" border="0" align="center" cellpadding="3" cellspacing="0">
            <tr>
              <td><div align="left"><img src="./images/ssm-new-logo.jpg" border="0" height="50" /></div></td>
              <td valign="bottom"><div align="center"><font color="#E36E38"><strong>Version 2.00</strong></font></div></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
              </tr>
            ...
            <tr>
              <td colspan="2" style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="4" style="border:1px solid #a9a9a9;" bgcolor="#F8F8F8">
                  <tr>
                    <td colspan="2" bgcolor="#F8F8F8"><div align="center" id="form-error">
                  ...
                  <tr>
                    ...
                    <td width="63%" bgcolor="#F8F8F8"><input name="username" type="text" class="form-fileds" id="username" size="25" /></td>
                  </tr>
                  <tr>
                    <td bgcolor="#F8F8F8">Password:</td>
                    <td bgcolor="#F8F8F8"><input name="password" type="password" class="form-fileds" id="password" size="25" /></td>
                  </tr>
                  <tr>
                    <td colspan="2" height="4"></td>
                  </tr>
                  <tr>
                    <td colspan="2" align="center" bgcolor="#F8F8F8"><input name="login" type="submit" class="swiftchoicebutton-red" id="login" value="Login"  onclick="checknavigatorproperties()" />  &nbsp;&nbsp;&nbsp;
                       <input name="clear" type="reset" class="swiftchoicebutton-red" id="clear" value="Clear" onclick="clearinnerhtml();" /></td>
                  </tr>
      ...
      <tr>
        <td align="center" class="page-footer">A product of Relyon Web Management | Copyright © 2012 Relyon Softech Ltd. All rights reserved.</td>
      </tr>
    </table></td>
  </tr>
</table>
