                      ...
                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top"><input name="dealercompanyname" type="text" class="swifttext"
                                id="dealercompanyname" size="30" />
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><input name="dealername" type="text" class="swifttext" id="dealername"
                                size="30" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">Contact Number:</td>
                            <td valign="top"><input name="contactnumber" type="text" class="swifttext" id="contactnumber"
                                size="30" /></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                      ...
                      <td width="50%" valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top"><input name="district" type="text" class="swifttext" id="district"
                                size="30" />
                            </td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Place:</td>
                            <td valign="top"><input name="place" type="text" class="swifttext" id="place" size="30" />
                            </td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">State:</td>
                            <td valign="top"><input name="state" type="text" class="swifttext" id="state" size="30" />
                            </td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Skype ID:</td>
                            <td valign="top"><input name="skypeid" type="text" class="swifttext" id="skypeid" size="30" />
                            </td>
                          </tr>
                        </table>
                      </td>
