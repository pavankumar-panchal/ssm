      ...
      <tr>
        <td colspan="2" valign="top"><div id="maindiv">
          <form action="" method="post" name="submitform" id="submitform" onsubmit="return false;">
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
              <tr>
                <td valign="middle" align="center" style="border-bottom:1px solid #d1dceb; padding:0" height="170"><div id="displayregisters"><img src="../images/warn.gif" border="0" align="absmiddle" />&nbsp; <strong>Make A Selection of record from the grid below</strong></div></td>
                </tr>
              <tr>
                  ...
                  <tr>
                    <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                        ...
                        <tr bgcolor="#edf4ff">
                          ...
                          <td valign="top"><label>
                            <input type="radio" name="authorizedatabasefield" id="authorizedatabasefield0" value="yes" checked="checked" />
                            Yes </label>
                            <label>
                            <input type="radio" name="authorizedatabasefield" id="authorizedatabasefield1" value="no" />
No</label></td>
                        </tr>
                        <tr bgcolor="#f7faff">
...
Yes </label>
                            <label>
                            <input type="radio" name="flagdatabasefield" id="flagdatabasefield1" value="no" checked="checked"  />
No</label></td>
                        </tr>
                        <tr bgcolor="#f7faff">
                          <td valign="top" bgcolor="#EDF4FF">Publish:</td>
                          <td valign="top" bgcolor="#EDF4FF"><label>
                            <input type="radio" name="publishdatabasefield" id="publishdatabasefield0" value="yes"/>
Yes </label>
                            <label>
                            <input type="radio" name="publishdatabasefield" id="publishdatabasefield2" value="no" checked="checked"  />
No</label></td>
                        </tr>
  ...
  <tr>
                ...
                <td width="32%" height="35" align="right" valign="middle"><input name="save" type="submit" class="swiftchoicebutton" id="save" value="Save" onclick="formsubmit('save')" />
&nbsp;&nbsp;&nbsp;&nbsp;
<input name="new" type="reset" class="swiftchoicebutton" id="new" value="Clear" onclick="clearinnerhtml(); " />&nbsp;&nbsp;</td>
  </tr>
</table></td>
              </tr>
            </table>
              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="s_customerid" type="text" class="swifttext" id="s_customerid" size="30" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Category:</td>
                      <td valign="top"><select name="s_category"  id="s_category" class="swiftselect">
...
No</label>
                        <label>
                        <input type="radio" name="s_flagdatabasefield" id="s_flagdatabasefield2" value="" checked="checked"  />
Both</label></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Publish Record:</td>
                      <td valign="top"><label>
                        <input type="radio" name="s_publishdatabasefield" id="s_publishdatabasefield0" value="yes"/>
Yes </label>
                        <label>
                        <input type="radio" name="s_publishdatabasefield" id="s_publishdatabasefield1" value="no"  />
No</label> <label>
                        <input type="radio" name="s_publishdatabasefield" id="s_publishdatabasefield1" value="" checked="checked"  />
Both</label></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                ...
                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tr bgcolor="#f7faff">
                    ...
                    <tr bgcolor="#f7faff">
                      <td valign="top">Authorized:</td>
                      <td valign="top"><label>
                        <input type="radio" name="s_authorizedatabasefield" id="s_authorizedatabasefield0" value="yes" checked="checked" />
Yes </label>
                        <label>
                        <input type="radio" name="s_authorizedatabasefield" id="s_authorizedatabasefield1" value="no" />
No</label><label>
                        <input type="radio" name="s_authorizedatabasefield" id="s_authorizedatabasefield2" value="" checked="checked" />
Both </label></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Status:</td>
                      <td valign="top"><input name="s_status" type="text" class="swifttext" id="s_status" size="30" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                   ...
                   <!-- <tr bgcolor="#f7faff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="s_compliantid" type="text" class="swifttext" id="s_compliantid" size="30" /></td>
                    </tr>
                   <tr bgcolor="#F7FAFF">
    ...
    <td style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr style="border-left:none; border-right:none;">
        <td style="padding:0; border:none;" width="26%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="84px" align="center" id="tabgroupgridh1" onclick="gridtab2('1','tabgroupgrid');" style="cursor:pointer" class="grid-active-tabclass">Default-Calls</td>
              <td width="2">&nbsp;</td>
