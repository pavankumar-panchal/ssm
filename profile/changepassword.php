          ...
          <form action="" method="post" name="submitform" id="submitform">
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
              <tr>
                <td colspan="2" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="password" type="password" class="swifttext" id="password" size="30" /></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">New Password:</td>
                      <td valign="top"><input name="newpassword" type="password" class="swifttext" id="newpassword" size="30" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Confirm Password:</td>
                      <td valign="top"><input name="confirmpassword" type="password" class="swifttext" id="confirmpassword" size="30" /></td>
                    </tr>
                </table></td>
                </tr>
              ...
              <tr>
                ...
                <td width="75%" align="left" valign="middle" ><div id="form-error"><?php 
                $message="";
                echo($message) 
                ?></div></td>
