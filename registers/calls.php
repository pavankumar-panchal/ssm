              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top" bgcolor="#f7faff"><label>
                        <input name="anonymous" type="radio" id="databasefield9" onclick="formsubmitcustomer();"value="yes" />
                        Yes</label>
                          <label>
                          <input name="anonymous" type="radio" id="databasefield10" onclick="formsubmitcustomer();" value="no" checked="checked" />
                            No</label>
                      </td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top" bgcolor="#EDF4FF">Registered Name:</td>
                      <td valign="top" bgcolor="#EDF4FF"><input name="customername" type="text" class="swifttext" id="customername" size="30" autocomplete="off" readonly="readonly" style="background:#FEFFE6;"/>
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top" bgcolor="#F7FAFF"><input name="customerid" type="text" class="swifttext" id="customerid" size="30" autocomplete="off" readonly="readonly" style="background:#FEFFE6;" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top" bgcolor="#EDF4FF"><input name="category" type="text" class="swifttext" id="category" size="30"  autocomplete="off" readonly="readonly" style="background:#FEFFE6;" />                        </td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top" bgcolor="#EDF4FF">
                        <input name="callertype" type="text" class="swifttext" id="callertype" size="30"  autocomplete="off" readonly="readonly" style="background:#FEFFE6;"  />                        </td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top" bgcolor="#EDF4FF"><input name="personname" type="text" class="swifttext" id="personname" size="30"  autocomplete="off" /><br /></td>
                    </tr>
                </table></td>
                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top" bgcolor="#edf4ff"><textarea name="remarks" cols="45" class="swifttextarea" id="remarks"></textarea></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top" bgcolor="#edf4ff"><input name="compliantid" type="text" class="swifttext" id="compliantid" size="30" maxlength="40" readonly="readonly" autocomplete="off" style="background:#FEFFE6;"/></td>
                    </tr>
                    <tr bgcolor="#f7faff">
              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><label></label>
                          ...
                          <input type="radio" name="s_anonymous" id="databasefield12" value="no" />
                            No</label>
                          <label>
                          <input type="radio" name="s_anonymous" id="databasefield13" value="" checked="checked" />
                            Both</label>
                          <label></label></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                    ...
                    <tr bgcolor="#f7faff">
                      <td valign="top" bgcolor="#EDF4FF">Category:</td>
                      <td valign="top" bgcolor="#EDF4FF">
                        <label><input name='categoryblr' type='checkbox' id='categoryblr' value='' checked="checked"/>BLR</label>
                        <label><input name='categorycsd' type='checkbox' id='categorycsd' value='' checked="checked"/>CSD</label>
                        <label><input name='categorykkg' type='checkbox' id='categorykkg' value='' checked="checked"/>KKG </label>
                      </td>
                    </tr>
                     <tr bgcolor="#f7faff">
...
No</label>
                            <label><input type="radio" name="flagdatabasefield" id="flagdatabasefield2" value="" checked="checked"  />
 Both</label> </td>
                    </tr>
                    <tr bgcolor="#edf4ff">
  ...
  <tr>
    <td style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr style="border-left:none;border-right:none;">
        ...
        <td width="54%"><span id="tabgroupgridwb1"></span><span id="tabgroupgridwb2"></span><span id="tabgroupgridwb3"></span><span id="tabgroupgridwb4"></span><span id="tabgroupgridwb5"></span></td>
      </tr>
    </table></td>
  </tr>
  <tr>
