...
<script language="javascript" src="../functions/emailregister.js?dummy = <?php echo (rand());?>" type="text/javascript"></script>
            ...
            <td colspan="2" valign="top"><div id="maindiv">
                <form action="" method="post" name="submitform" id="submitform" onSubmit="return false;">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                      <td colspan="2" style="padding:2px"><table width="50%" border="0"  cellspacing="0" cellpadding="0">
                          <tr >
                            <td colspan="2" style="padding-left:3px"><div class="amctext" ><strong>AMC Info:</strong><span style="padding-left:10px"  id="amcdisplayinfo"> Select a Customer</span> </div></td>
                          </tr>
                          <tr>
                            <td colspan="2" style="padding-left:3px" ><div id="amcdisplaydiv" style="display:none; width:540px;" class="amcdisplay">
                                <table border="0" cellspacing="0" cellpadding="3"    >
                                  ...
                                  <tr>
                                    <td colspan="2" ><div style="padding:5px; overflow:auto; width:510px; height:100px" id="displayamcdetails"  align="center"></div></td>
                                  </tr>
                                  <tr>
                                    <td  width="25%">&nbsp;</td>
                                    <td width="75%" height="35" align="right" valign="middle" style="padding-right:10px" ><input name="close" type="button" class="swiftchoicebutton" id="close" value="Close" onclick="document.getElementById('amcdisplaydiv').style.display = 'none';" />
                                    </td>
                                  </tr>
                                </table>
                              </div></td>
                    ...
                    <tr>
                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top" bgcolor="#f7faff"><label>
                              <input name="anonymous" type="radio" id="databasefield0" onclick="formsubmitcustomer();"value="yes" />
                              Yes</label>
                              <label>
                              <input name="anonymous" type="radio" id="databasefield1" onclick="formsubmitcustomer();" value="no" checked="checked" />
                              No</label>
                            </td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Registered Name:</td>
                            <td valign="top" bgcolor="#edf4ff"><input name="customername" type="text" class="swifttext" id="customername" style="background:#FEFFE6;" size="30" maxlength="250" autocomplete="off" value=""/>
                              <span id="getcustomerlink" style="visibility:visible"> <a href="javascript:void(0);" onclick="getcustomer(); getcustomerfunc();registernameload('email');" style="cursor:pointer"> <img src="../images/userid-bg.gif" width="14" height="16" border="0" align="absmiddle" /></a></span>
                              ...
                              <input type="hidden" name="hiddenserverdate" id="hiddenserverdate" value="<?php echo(datetimelocal('d-m-Y')); ?>"/></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">Customer ID:</td>
                            <td valign="top"><input name="customerid" type="text" class="swifttext" id="customerid" size="30" autocomplete="off" value="" style="background:#FEFFE6;"/>
                            </td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Date:</td>
                            <td valign="top"><input name="date" type="text" class="swifttext" id="date" size="30" autocomplete="off" readonly="readonly" value="<?php echo(datetimelocal('d-m-Y')); ?>" style="background:#FEFFE6;" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">Time:</td>
                            <td valign="top"><input name="time" type="text" class="swifttext" id="time" size="30" autocomplete="off" readonly="readonly" value="<?php echo(datetimelocal('H:i:s')); ?>"  style="background:#FEFFE6;" /></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Category:</td>
                            <td valign="top"><input name="category" type="text" class="swifttext" id="category" size="30"  autocomplete="off" style="background:#FEFFE6;" value=""/></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top" >Caller Type:</td>
                            <td valign="top"><input name="callertype" type="text" class="swifttext" id="callertype" size="30"  autocomplete="off" value="" style="background:#FEFFE6;"/></td>
                          </tr>
                           <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top">
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top"><input name="personname" type="text" class="swifttext" id="personname" size="30"  autocomplete="off" value=""/></td>
                          </tr>
                            <tr bgcolor="#edf4ff">
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top"><input name="emailid" type="text" class="swifttext" id="emailid" size="30"  autocomplete="off"/></td>
                          </tr>
                          <tr bgcolor="#EDF4FF">
                            <td valign="top">Subject:</td>
                            <td valign="top"><input name="subject" type="text" class="swifttext" id="subject" size="30" maxlength="50"  autocomplete="off"/></td>
                          </tr>
                        </table></td>
                      <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr bgcolor="#f7faff">
                            <td valign="top">Problem:</td>
                            <td valign="top"><textarea name="content" cols="45" class="swifttextarea" id="content"></textarea>
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><input name="errorfile" type="text" class="swifttext" id="errorfile" size="30"  autocomplete="off" readonly="readonly"  style="background:#FEFFE6;"/>
                              <img  id="myfileuploadimage" src="../images/fileattach.jpg" border="0" align="absmiddle" onclick="fileuploaddivid('downloadlinkfile','errorfile','fileuploaddiv','310px','70%')"/> <span id="downloadlinkfile"></span></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><textarea name="remarks" cols="45" class="swiftselect" id="remarks"></textarea></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><input name="compliantid" type="text" class="swifttext" id="compliantid" size="30" maxlength="50" readonly="readonly"  autocomplete="off" style="background:#FEFFE6;"/></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                    ...
                    <tr>
                      <td colspan="2" align="right" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="35">
                          <tr>
                            ...
                            <td width="32%" height="35" align="right" valign="middle"><input name="new" type="reset" class="swiftchoicebutton" id="new" value="New" onclick="setradiovalue(document.getElementById('submitform').anonymous, 'no'); newentry(); formsubmitcustomer(); clearinnerhtml();clearform();gettime();" />
                              &nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><input name="s_customername" type="text" class="swifttext" id="s_customername" size="30" />
                            </td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">Customer ID:</td>
                            <td valign="top"><input name="s_customerid" type="text" class="swifttext" id="s_customerid" size="30" autocomplete="off"/>
                            </td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Category:</td>
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top" bgcolor="#F7FAFF"><input name="s_emailid" type="text" class="swifttext" id="s_emailid" size="30"  autocomplete="off"  /></td>
                          </tr>
                        </table></td>
                      <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr bgcolor="#f7faff">
                            <td valign="top">Content:</td>
                            <td valign="top"><input name="s_content" type="text" class="swifttextarea" id="s_content" value="" size="30" /></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Status:</td>
                          ...
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Error File:</td>
                            <td valign="top"><input name="s_errorfile" type="text" class="swifttext" id="s_errorfile" size="30"  autocomplete="off"/></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">Thanking Email:</td>
                            <td valign="top"><label>
                              ...
                              No</label>
                              <label>
                              <input type="radio" name="s_thankingemail" id="s_thankingemail2" value="" checked="checked" />
                              Both</label></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Entered By:</td>
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><label>
                              ...
                              No</label>
                              <label>
                              <input type="radio" name="flagdatabasefield" id="flagdatabasefield2" value="" checked="checked"  />
                              Both</label></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
