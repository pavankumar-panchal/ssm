...
<script language="javascript" src="../functions/errorregister.js?dummy = <?php echo (rand());?>" type="text/javascript"></script>
 <div id="contentdiv" style="display:block;">
                    ...
                    <tr>
                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><label>
                              ...
                              <span id="getcustomerlink" style="visibility:visible;"><a href="javascript:void(0);" onClick="getcustomer(); getcustomerfunc();registernameload('error')" style="cursor:pointer"><img src="../images/userid-bg.gif" width="14" height="16" border="0" align="absmiddle" /></a></span>
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top">
                              <input name="time" type="text" class="swifttext" id="time" size="30" autocomplete="off" readonly="readonly" value="<?php echo(datetimelocal('H:i:s')); ?>" style="background:#FEFFE6;"  /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><span id="productversiondisplay"><select name="productversion" id="productversion" class="swiftselect">
                              <option value="">Make A Selection</option>
                            </select>  </span>                          </td>
                          </tr>
                          <tr bgcolor="#f7faff">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><textarea name="errorreported" cols="45" class="swifttextarea" id="errorreported"></textarea>
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top"><textarea name="errorunderstood" cols="45" class="swifttextarea" id="errorunderstood"></textarea></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top"><input name="errorfile" type="text" class="swifttext" id="errorfile" size="30"  autocomplete="off" readonly="readonly"  style="background:#FEFFE6;"/>
                              <img  id="myfileuploadimage" src="../images/fileattach.jpg" border="0" align="absmiddle" onclick="fileuploaddivid('downloadlinkfile','errorfile','fileuploaddiv','430px','20%')"/> <span id="downloadlinkfile"></span></td>
                          </tr>
                      </table></td>
                      <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><input name="solveddate" type="text" class="swifttext" id="DPC_solveddate" size="30"  autocomplete="off" style="background:#FEFFE6;" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">Solution Given:</td>
                            <td valign="top"><textarea name="solutiongiven" cols="45" class="swifttextarea" id="solutiongiven"></textarea></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Solution Entered Time:</td>
                            <td valign="top"><input name="solutionenteredtime" type="text" class="swifttext" id="solutionenteredtime" size="30" readonly="readonly" value=""  autocomplete="off" style="background:#FEFFE6;"/></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">Solution File:</td>
                            <td valign="top"><input name="solutionfile" type="text" class="swifttext" id="solutionfile" size="30"  autocomplete="off" readonly="readonly"  style="background:#FEFFE6;"/>
                              <img src="../images/fileattach.jpg" name="myfileuploadimage1" border="0" align="absmiddle" id="myfileuploadimage1" onclick="fileuploaddivid('downloadlinkfile1','solutionfile','fileuploaddiv','330px','65%')"/> <span id="downloadlinkfile1"></span> </td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><input name="errorid" type="text" class="swifttext" id="errorid" size="30" readonly="readonly"  autocomplete="off" style="background:#FEFFE6;"/></td>
                          </tr>
                          <tr bgcolor="#f7faff">
  ...
  <tr>
                <td width="60%" height="35" align="left" valign="middle"><div id="form-error"></div></td>
                <td width="40%" height="35" align="right" valign="middle"><input name="new" type="reset" class="swiftchoicebutton" id="new" value="New" onclick="setradiovalue(document.getElementById('submitform').anonymous, 'no'); newentry(); formsubmitcustomer(); clearinnerhtml(); gettime();" />
&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;
<input name="errorreport" type="submit" class="swiftchoicebuttondisabled" id="errorreport" value="Error Report"  onclick="formsubmit('errorreport')" disabled="disabled"/>&nbsp;&nbsp;&nbsp;</td>
  </tr>
</table>
</td>
              </tr>
                    ...
                    <tr>
                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top" bgcolor="#EDF4FF"><input name="s_errorreported" type="text" class="swifttext" id="s_errorreported" value="" size="30" />                            </td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top" bgcolor="#F7FAFF">Reported To:</td>
                            <td valign="top" bgcolor="#F7FAFF"><input name="s_reportedto" type="text" class="swifttext" id="s_reportedto" size="30" autocomplete="off" />                            </td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top" bgcolor="#EDF4FF">Error File:</td>
                            <td valign="top" bgcolor="#EDF4FF"><input name="s_errorfile" type="text" class="swifttext" id="s_errorfile" size="30"  autocomplete="off"/>                            </td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top" bgcolor="#F7FAFF">Status:</td>
                            <td valign="top" bgcolor="#F7FAFF"><select name="s_status" id="s_status" class="swiftselect">
                      ...
                      <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr bgcolor="#f7faff">
                            <td valign="top">Solved Date:</td>
                            <td valign="top"><input name="s_solveddate" type="text" class="swifttext" id="DPC_s_solveddate" size="30"  autocomplete="off" style="background:#FEFFE6;" /></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Solution Given:</td>
                            <td valign="top"><input name="s_solutiongiven" type="text" class="swifttext" id="s_solutiongiven" value="" size="30" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top" bgcolor="#f7faff">Solution File:</td>
                            <td valign="top"><input name="s_solutionfile" type="text" class="swifttext" id="s_solutionfile" size="30"  autocomplete="off"/></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Remarks:</td>
                            <td valign="top"><input name="s_remarks" type="text" class="swifttext" id="s_remarks" value="" size="30" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">Entered By:</td>
                          ...
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Error ID:</td>
                            <td valign="top"><input name="s_errorid" type="text" class="swifttext" id="s_errorid" size="30" maxlength="40" autocomplete="off" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
...
No</label><label><input type="radio" name="flagdatabasefield" id="flagdatabasefield2" value="" checked="checked"  />
 Both</label></td>
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top" bgcolor="#EDF4FF"><select name="s_supportunit" class="swiftselect" id="s_supportunit"  >
                              <option value="">ALL</option>
