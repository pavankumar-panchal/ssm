                        ...
                        <td width="50%" valign="top" style="border-right:1px solid #d1dceb;">
                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr bgcolor="#f7faff">
                              ...
                              <td valign="top"><input name="customername" type="text" class="swifttext"
                                ...
                                <input type="hidden" name="loggedreportingauthority" id="loggedreportingauthority"
                                  value="<?php echo ($reportingauthority); ?>" style="background:#FEFFE6;" />
                            ...
                            <tr bgcolor="#f7faff">
                              ...
                              <td valign="top" bgcolor="#EDF4FF">
                                <select name="state" id="state" class="swiftselect" autocomplete="off"
                            ...
                            <tr bgcolor="#f7faff">
                              ...
                              <td valign="top"><input name="contactperson" type="text" class="swifttext"
                                  id="contactperson" size="30" autocomplete="off" /></td>
                            </tr>
                            <tr bgcolor="#edf4ff">
                        ...
                        <td width="50%" valign="top">
                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr bgcolor="#f7faff">
                              ...
                              <td valign="top" bgcolor="#EDF4FF"><select name="supportunit" class="swiftselect"
                                  id="supportunit">
                            ...
                            <tr bgcolor="#edf4ff">
                              ...
                              <td valign="top" bgcolor="#F7FAFF">
                                <select name="assignedto" class="swiftselect" id="assignedto" <?php if ($usertype <> 'ADMIN' && $usertype <> 'MANAGEMENT' && $usertype <> 'TEAMLEADER' && $usertype <> 'EXECUTIVE-ONSITE') { ?> disabled="disabled">
                                    <option value="">Make A Selection</option>
                            ...
                            <tr bgcolor="#f7faff">
                              ...
                              <td valign="top" bgcolor="#EDF4FF"><select name="solvedby" class="swiftselect"
                            ...
                            <tr bgcolor="#f7faff">
                              ...
                              <td valign="top" bgcolor="#EDF4FF"><input name="solveddate" type="text" class="swifttext"
                                  id="DPC_solveddate" size="30" maxlength="10" autocomplete="off"
                                  style="background:#FEFFE6;" <?php if ($usertype <> 'ADMIN' && $usertype <> 'MANAGEMENT' && $usertype <> 'TEAMLEADER' && $usertype <> 'EXECUTIVE-ONSITE') { ?>
                                    disabled="disabled" <?php } ?> /></td>
                            </tr>
                            <tr bgcolor="#edf4ff">
                              <td valign="top" bgcolor="#F7FAFF">Bill Number:</td>
                              <td valign="top" bgcolor="#F7FAFF"><input name="billno" type="text" class="swifttext"
                                  id="billno" size="30" autocomplete="off" <?php if ($usertype <> 'ADMIN' && $usertype <> 'MANAGEMENT' && $usertype <> 'TEAMLEADER' && $usertype <> 'EXECUTIVE-ONSITE') { ?>
                                    disabled="disabled" <?php } ?> /></td>
                            </tr>
                            <tr bgcolor="#f7faff">
                              <td valign="top" bgcolor="#EDF4FF">Bill Date:</td>
                              <td valign="top" bgcolor="#EDF4FF"><input name="billdate" type="text" class="swifttext"
                                  id="DPC_billdate" size="30" maxlength="10" autocomplete="off"
                                  style="background:#FEFFE6;" <?php if ($usertype <> 'ADMIN' && $usertype <> 'MANAGEMENT' && $usertype <> 'TEAMLEADER' && $usertype <> 'EXECUTIVE-ONSITE') { ?>
                                    disabled="disabled" <?php } ?> /></td>
                            </tr>
                            <tr bgcolor="#edf4ff">
                              <td valign="top" bgcolor="#F7FAFF">Acknowledgement Number:</td>
                              <td valign="top" bgcolor="#F7FAFF"><input name="acknowledgementno" type="text"
                                  class="swifttext" id="acknowledgementno" value="" size="30" maxlength="20"
                            ...
                            <tr bgcolor="#f7faff">
                              ...
                              <td valign="top" bgcolor="#EDF4FF"><textarea name="remarks" cols="45"
                                  class="swifttextarea" id="remarks" <?php if ($usertype <> 'ADMIN' && $usertype <> 'MANAGEMENT' && $usertype <> 'TEAMLEADER' && $usertype <> 'EXECUTIVE-ONSITE') { ?>
                                    disabled="disabled" <?php } ?>></textarea></td>
                            </tr>
                            <tr bgcolor="#edf4ff">
                            ...
                            <tr bgcolor="#f7faff">
                              ...
                              <td valign="top" bgcolor="#EDF4FF"><input name="complaintid" type="text" class="swifttext"
                                  id="complaintid" size="30" maxlength="40" readonly="readonly" autocomplete="off"
                      ...
                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top" bgcolor="#F7FAFF"><input name="s_problem" type="text" class="swifttextarea"
                                id="s_problem" value="" size="30" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top" bgcolor="#EDF4FF">Status:</td>
                            <td valign="top" bgcolor="#EDF4FF"><select name="s_status" class="swiftselect"
                                id="s_status">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><input name="s_solveddate" type="text" class="swifttext"
                                id="DPC_s_solveddate" size="30" maxlength="10" autocomplete="off"
                                style="background:#FEFFE6;" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><input name="s_billno" type="text" class="swifttext" id="s_billno"
                                size="30" autocomplete="off" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">Acknowledgement Number:</td>
                            <td valign="top"><input name="s_acknowledgementno" type="text" class="swifttext"
                                id="s_acknowledgementno" value="" size="30" autocomplete="off" /></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
