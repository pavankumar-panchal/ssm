...
if (isset($customer) && isset($dealer) && isset($osemployee)) {
	$callertype = "";
} elseif (isset($osemployee) && isset($customer)) {
	$callertype = "AND (callertype='outstationemployee' OR callertype='customer')";
} elseif (isset($osemployee) && isset($dealer)) {
	$callertype = "AND (callertype='outstationemployee' OR callertype='dealer')";
...
} elseif (isset($osemployee)) {
	$callertype = "AND callertype='outstationemployee'";
}
