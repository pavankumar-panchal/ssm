...
<script language="javascript" src="../functions/bug-statistics.js?dummy = <?php echo (rand());?>" type="text/javascript"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
              ...
              <tr>
                <td valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="errorreported" type="text" class="swifttext" id="errorreported" size="30" autocomplete="off" /></td>
                    </tr>
  ...
  <tr>
    <td style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #6393df; border-top:none;">
      ...
      <tr>
        <td colspan="3" align="center" valign="top"><form name="gridformbug" id="gridformbug" action="../reports-excel/bug-report.php" method="post"><div id="tabgroupgridc1" style="overflow:auto; height:300px; width:1060PX; padding:2px;" align="center"></div>
