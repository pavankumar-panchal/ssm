...
<script language="javascript" src="../functions/call-statistics.js?dummy = <?php echo (rand());?>" type="text/javascript"></script>
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><label><input name='check[]' type='checkbox' value='Call' checked="checked"/>
Calls</label><label>
...
<input type="hidden" name="lastslno" id="lastslno" value="" />
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><input name="fromdate" type="text" class="swifttext" id="DPC_fromdate" size="30" autocomplete="off"  style="background:#FEFFE6;"  value="<?php echo(datetimelocal('d-m-Y')); ?>"/></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><label>
                        <input name='customer' type='checkbox' id='customer' value='Customer' checked="checked"/>
Customers </label><label>
                        <input name='dealer' type='checkbox' id='dealer' value='Dealer' checked="checked"/>
Dealers</label>
                        <label>
                        <input name='employee' type='checkbox' id='employee' value='employee' checked="checked"/>
 ...
 SSM Users</label></td>
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><label><input type="radio" name="anonymous" id="databasefield11" value="yes"/> Yes</label>
                        <label><input type="radio" name="anonymous" id="databasefield12" value="no" /> No</label>
                        <label><input type="radio" name="anonymous" id="databasefield13" value="" checked="checked" /> Both</label></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Report on:</td>
                      <td valign="top"><label>
<input name="reporton" type="radio" id="reporton0" value="statistics" checked="checked"/> 
Statistics</label>
                        <label>
...
Details</label>
  ...
  <tr>
                ...
                <td width="32%" height="35" align="right" valign="middle"><input name="view" type="submit" class="swiftchoicebutton" id="view" value="View" onClick="formsubmit('view');" />
&nbsp;&nbsp;&nbsp;
<input name="toexcel" type="submit" class="swiftchoicebutton-orange" id="toexcel" value="To Excel" onClick="formsubmit('toexcel');" /></td>
  </tr>
</table></td>
              </tr>
            </table>
  ...
  <tr>
    <td style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #6393df; border-top:none;">
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2" valign="top"><div id="displaystatsreport" style="overflow:auto; height:300px; width:1060PX; padding:2px;" align="center"></div></td>
          <td>&nbsp;</td>
        </tr>
    </table></td>
  </tr>
