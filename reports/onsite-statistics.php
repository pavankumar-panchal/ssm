              ...
              <tr>
                <td valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top" bgcolor="#F7FAFF"><input type="checkbox" name="servicecharge" id="servicecharge" onClick="javascript:enableoutstandingbills();" /></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
...
Mail </label></td>
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top" bgcolor="#EDF4FF"><label><input type="radio" name="anonymous" id="databasefield11" value="yes"/> Yes</label>
...
Pending Visits</label></td>
                ...
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="complaintid" type="text" class="swifttext" id="complaintid" size="30"  autocomplete="off"/></td>
                    </tr>
  ...
  <tr>
                ...
                <td width="32%" height="35" align="right" valign="middle"><input name="view" type="submit" class="swiftchoicebutton" id="view" value="View" onClick="formsubmit('toview');" />
                  &nbsp;&nbsp;&nbsp;&nbsp;
