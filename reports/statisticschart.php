...
<input type="hidden" name="lastslno" id="lastslno" value="" />
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="status" type="text" class="swifttext" id="status" size="30" autocomplete="off" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
...
Dealers</label>
 ...
 SSM Users</label>
                         &nbsp;&nbsp;&nbsp;[Not Available for Email Non Customers, Errors, References, Requirements]</td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top" bgcolor="#F7FAFF">Category:</td>
                      <td valign="top" bgcolor="#F7FAFF"><select name="category"  id="category" class="swiftselect">
...
Both</label>
  ...
  <tr>
                ...
                <td width="32%" height="35" align="right" valign="middle"><input name="view" type="submit" class="swiftchoicebutton" id="view" value="View" onClick="gettimelinedata()" />
</td>
  </tr>
</table></td>
              </tr>
  ...
  <tr>
    <td><div id='chart_div' style='width: 700px; height: 240px;'></div>
</td>
  </tr>
</table>
</div>
